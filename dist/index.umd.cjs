(function(o,p){typeof exports=="object"&&typeof module<"u"?module.exports=p():typeof define=="function"&&define.amd?define(p):(o=typeof globalThis<"u"?globalThis:o||self,o.GradingPyramid=p())})(this,function(){"use strict";var E=Object.defineProperty;var G=(o,p,m)=>p in o?E(o,p,{enumerable:!0,configurable:!0,writable:!0,value:m}):o[p]=m;var y=(o,p,m)=>(G(o,typeof p!="symbol"?p+"":p,m),m);let o=[],p=(b,t)=>{let e=[],r={get(){return r.lc||r.listen(()=>{})(),r.value},l:t||0,lc:0,listen(i,a){return r.lc=e.push(i,a||r.l)/2,()=>{let s=e.indexOf(i);~s&&(e.splice(s,2),--r.lc||r.off())}},notify(i){let a=!o.length;for(let s=0;s<e.length;s+=2)o.push(e[s],e[s+1],r.value,i);if(a){for(let s=0;s<o.length;s+=4){let n;for(let l=s+1;!n&&(l+=4)<o.length;)o[l]<o[s+1]&&(n=o.push(o[s],o[s+1],o[s+2],o[s+3]));n||o[s](o[s+2],o[s+3])}o.length=0}},off(){},set(i){r.value!==i&&(r.value=i,r.notify())},subscribe(i,a){let s=r.listen(i,a);return i(r.value),s},value:b};return r};function m(b,t,e){let r=new Set([...t,void 0]);return b.listen((i,a)=>{r.has(a)&&e(i,a)})}let x=(b={})=>{let t=p(b);return t.setKey=function(e,r){typeof r>"u"?e in t.value&&(t.value={...t.value},delete t.value[e],t.notify(e)):t.value[e]!==r&&(t.value={...t.value,[e]:r},t.notify(e))},t};class ${constructor(t,e){y(this,"mounted");y(this,"container");y(this,"store",x());y(this,"defaultOptions",{render:!0,baseGrade:{front:{color:"rgba(120, 120, 120, 0.35)"},back:{color:"rgba(120, 120, 120, 0.35)"},left:{color:"rgba(220, 220, 220, 0.35)"},right:{color:"rgba(220, 220, 220, 0.35)"},top:{color:"rgba(20, 0, 250, 0.55)"},bottom:{color:"rgba(20, 0, 250, 0.55)"}},hideSides:[],running:!0,speed:6e3,scope:"default",gap:10,height:300,width:200,gradesNumber:1,perspective:1500,toolbar:!1,onClick:()=>{}});y(this,"baseGrade");y(this,"scope");y(this,"running");y(this,"onClick");const r=typeof t=="string"?document.querySelector(t):t;if(!r)throw new Error("Target not found");this.container=r;const{render:i,running:a,speed:s,baseGrade:n,scope:l,height:d,width:c,gap:g,gradesNumber:f,perspective:h,hideSides:u,toolbar:v,onClick:w}={...this.defaultOptions,...e};this.scope=l,this.baseGrade=n,this.running=a,this.onClick=w,this.store.set(Object.assign({},this.store.get(),{paused:!a,speed:s,perspective:h,height:d,width:c,gap:g,gradesNumber:f,hideSides:u,toolbar:v})),i&&this.render(),m(this.store,["paused"],({paused:z})=>{z?this.pause(!1):this.play(!1)}),m(this.store,["gradesNumber","gap","grades","height","width","hideSides"],()=>{this.mounted=this.mounted||!!document.querySelector(this.cls("shape",!0)),this.mounted?(this.prune(),this.mount()):this.render()})}play(t=!0){document.querySelectorAll(this.cls("grade",!0)).forEach(e=>{const r=e;r.style.animationPlayState="running"}),t&&this.store.setKey("paused",!1)}pause(t=!0){document.querySelectorAll(this.cls("grade",!0)).forEach(e=>{const r=e;r.style.animationPlayState="paused"}),t&&this.store.setKey("paused",!0)}mutate(t,e){this.store.setKey(t,e)}setGrades(t){this.store.setKey("grades",t)}setGradesNumber(t){this.store.setKey("gradesNumber",t)}prune(){var t;(t=this.container.querySelector(this.cls("shape",!0)))==null||t.remove()}mount(){const{toolbar:t}=this.store.get(),e=this.render();t&&e.append(this.toolbarDom()),this.container.append(e),document.head.querySelector(`style[data-pyramid="${this.scope}"]`)||document.head.append(this.style())}render(){const{gradesNumber:t,height:e,width:r,gap:i,grades:a=[]}=this.store.get(),s=Array(t).fill({}).map((d,c)=>a[c]??{}),n=document.createElement("article");n.classList.add(this.cls("shape"));const l=[];for(let d=0;d<s.length;d++){const c=s[d],g={height:e*((d+1)/s.length),width:r*((d+1)/s.length)-i},f={height:g.height/(1+d),margin:d?i:0};l.push(this.computeGrade({pyramid:g,trapezoidal:f},this.gradeDom(c,d)))}return n.append(...l),n}toolbarDom(){const{paused:t}=this.store.get(),e=document.createElement("nav");e.classList.add(this.cls("toolbar"));const r=document.createElement("button");r.innerText=t?"▶️":"⏸️",m(this.store,["paused"],({paused:a})=>{r.innerText=a?"▶️":"⏸️"}),r.addEventListener("click",()=>{this.store.setKey("paused",!this.store.get().paused)});const i=document.createElement("input");return i.type="number",i.value=this.store.get().gradesNumber.toString(),i.min="1",i.addEventListener("change",a=>{var n;const s=(n=a.target)==null?void 0:n.value;this.mutate("gradesNumber",parseInt(s,10))},!1),e.append(r,i),e}hoverGrade(t){const{paused:e}=this.store.get();!e&&this.store.setKey("paused",!0),t.target.classList.add(this.cls("-hover"))}leaveGrade(t){this.running&&this.store.setKey("paused",!1),t.target.classList.remove(this.cls("-hover"))}clickGrade(t,e){this.onClick(t,e)}gradeDom(t,e){const{gradesNumber:r,hideSides:i}=this.store.get(),a=document.createElement("section");a.classList.add(this.cls("grade")),a.style.zIndex=`${r-e}`,a.style.animationPlayState=this.running?"running":"paused",a.addEventListener("mouseenter",this.hoverGrade.bind(this)),a.addEventListener("mouseleave",this.leaveGrade.bind(this));const s=["front","back","left","right","top","bottom"].map(n=>{const{color:l,text:d,textColor:c,hide:g}={...this.baseGrade[n],...t[n]};if(typeof g=="boolean"&&g||i.includes(n))return"";const f=["top","bottom"].includes(n),h=document.createElement("aside");h.addEventListener("click",this.clickGrade.bind(this,{side:n,level:e+1})),h.classList.add(this.cls(f?"base":"face")),h.classList.add(this.cls("side")),h.classList.add(this.cls(n)),f?l&&(h.style.backgroundColor=l):l&&(h.style.borderBottomColor=l);const u=document.createElement("span");return u.classList.add(this.cls("text")),d&&(u.textContent=d),c&&(u.style.color=c),h.append(u),h});return a.append(...s),a}computeGrade(t,e){function r(h,u){var v=Math.atan(h/u),w=v*(180/Math.PI);return w}function i(h,u){var v=Math.sqrt(Math.pow(h,2)+Math.pow(u,2));return v}const a={height:400,width:200,...t.pyramid},s=i(a.height,a.width/2),n=i(s,a.width/2),l=90-r(s,a.width/2),d={height:40,margin:5,...t.trapezoidal},c=d.height/a.height,g=a.width/2*(1-c)-s*c,f=s*c+d.margin;return e.style.setProperty("--pyramid-trapezoidal-top-offset",`${g}`),e.style.setProperty("--pyramid-degrees",`${l}`),e.style.setProperty("--pyramid-width",`${a.width}`),e.style.setProperty("--pyramid-hypotenuse-length",`${n*c}`),e.style.setProperty("--pyramid-height",`${a.height}`),e.style.setProperty("--pyramid-slant-height",`${s}`),e.style.setProperty("--pyramid-trapezoidal-slant-height",`${f}`),e.style.setProperty("--pyramid-trapezoidal-height",`${d.height}`),e}cls(t,e){return`${e?".":""}pyramid-${t}-${this.scope}`}style(){const{perspective:t,speed:e}=this.store.get(),r=document.createElement("style");return r.dataset.pyramid=this.scope,r.innerHTML=`
.${this.cls("shape")} {
  perspective: ${t}px;
